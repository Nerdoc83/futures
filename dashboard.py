        ...
        if trades_df.empty:
            ...
            with col2:
                style_filter = st.multiselect(
                    "스타일 필터",
                    options=trades_df['trading_style'].dropna().unique().tolist(),
                    default=trades_df['trading_style'].dropna().unique().tolist()
                )
            ...
            filtered_df = trades_df[
                ...
                (trades_df['trading_style'].isin(style_filter)) &
            ...
            display_df = filtered_df[[
                ...
                'exit_price', 'leverage', 'investment_amount', 'pnl',
                'pnl_percentage', 'status', 'timestamp'
            ]].copy()
